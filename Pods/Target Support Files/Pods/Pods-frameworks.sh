...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework 'ABFRealmSearchViewController.framework'
  install_framework 'RBQFetchedResultsController.framework'
  install_framework 'Realm.framework'
  install_framework 'RealmSFRestaurantData.framework'
fi
